...
CompositionConfiguration::CompositionConfiguration()
{
    ...
    connect(m_OKButton, &QPushButton::clicked, this,
            &CompositionConfiguration::OKPressed);
    connect(m_CancelButton, &QPushButton::clicked, this,
            &CompositionConfiguration::CancelPressed);
    connect(m_AttributesList, &QListWidget::itemChanged, this,
            &CompositionConfiguration::attributesChanged);
}

QList<QString> CompositionConfiguration::getAttributes() const
{
...
void CompositionConfiguration::setAttributes(const QList<QString>& p_Attributes)
{
...
bool CompositionConfiguration::getAutoRoute() const
{
    return m_AutoRouteCheckBox->isChecked();
}
void CompositionConfiguration::setAutoRoute(bool p_isAutoRoute)
{
    m_AutoRouteCheckBox->setChecked(p_isAutoRoute);
}

// I_ConfigurationContent
void CompositionConfiguration::setFocusOnFirstZone()
{
    m_AttributesList->setFocus();
}

// I_ConfigLineEditListener
void CompositionConfiguration::enterPressed()
{
    this->OKPressed();
}
void CompositionConfiguration::escapePressed()
{
    this->CancelPressed();
}

// Slots
void CompositionConfiguration::OKPressed()
{
...
void CompositionConfiguration::CancelPressed()
{
    I_Configurable* l_Listener = this->getListener();
    if( nullptr != l_Listener)
    {
...
void CompositionConfiguration::attributesChanged()
{
